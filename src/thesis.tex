...
and we can lower a finite product componentwise.
...
as in Definition \ref{def:simple-eliminator-construction}. We generally observe
that
\begin{itemize}
  \item The inner theory has all necessary features to reproduce the eliminator
    construction.
  \item Types and constructions which are defined on both levels are essentially
    the same.
  \item Lowering preserves all relevant structure.
\end{itemize}
...
It would interesting to check if there is a possible alternative formulation of
...
%% \begin{itemize}
%%   \item The choice between weak and strict equations
%% \end{itemize}

%% when moving to 2LTT the essential extra detail that we have to manage is the choice
%% between weak and strict preservation, which
