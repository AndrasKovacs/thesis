...
and structurally recursive definitions, so it requires more work to see if it
can be translated to 2LTT in a generic way.
...
First, we specify signatures and present a number of examples. Then we build
semantics, term algebras and present \todo{todo}
