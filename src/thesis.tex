...
\section{Signature Semantics of Signatures}
...
As we shall see shortly, capturing the full flcwf semantics is possible with the
infinitary ToS, but it is not possible in the finitary case. The reason is that
the type formers in $\U$ are necessary to build some components of the
semantics. Recall that
