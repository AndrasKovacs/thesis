...
foundation for mechanized mathematics, also proves useful for more specialized
tasks.

We have an inevitable trade-off between the complexity of a mathematical
language and the ease of usage of the language, or, its encoding
overheads. Minimal languages are convenient to reason about and develop
metatheory for, but they often require unrealistic amounts of boilerplate to
work in. However, it is a worthwhile effort to try to move towards the Pareto
frontier of this trade-off. We believe that the current thesis makes progress in
this respect.
