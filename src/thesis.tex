...
functor. From this, it will also follow that categories of algebras have all $\Ty_0$-small
colimits. We have the following setup.
\begin{itemize}
  \item
  ...
  $\Sigma$ follow from the semantics given in Chapter \ref{chap:iqiit}. In
  the following we will need to talk about signatures depending on signatures,
  and $\top$ and $\Sigma$ are more convenient for this purpose than telescopes.
\end{itemize}
...
\todo{Corollary: signature semantics of signatures!}
