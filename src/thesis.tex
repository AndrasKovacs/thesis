...
in the semantics, we don't need a ToS syntax. A Church-like encoding suffices.
...
\subsubsection{Relation to the initiality conjecture}
...
There has been a prolonged debate about the merits of initiality constructions.
On one hand, some people believed that the initiality construction is essential
for morally justifying the usage of raw syntax, while using categorical notions
of models in the metatheory of type theory. On the other hand, some people
dismissed the initiality construction as a pointless exercise, considering the
categorical (QIIT-based) syntax the actual syntax, and raw syntax as merely
notation for that. The author of this thesis is on a somewhat different opinion
than either of the above.

First, as a moral justification of the usage of raw syntax, the initiality
construction is indeed mostly pointless. That's because \emph{elaboration}
comprises the actual justification for that. Elaboration is the effective
algorithm which converts raw syntax to ``core syntax'', i.e.\ typed categorical
syntax. Given a piece of raw syntax, even if I have done the initiality construction,
I have no effective way of learning which core syntactic object it corresponds to!
The elaboration literature is \emph{all about} practical justifications for using
certain raw syntaxes, and it comes with established ways to talk about power and
correctness of elaboration algorithms.
...
exists, as a target of elaboration, but it is orthogonal to the construction of
...
What about generic ways to formalize elaboration? It seems to be rather bad to
repeat this for every single type theory. To the author's knowledge, elaboration
has not been formalized even for a \emph{single} type theory in a practically
realistic way (i.e.\ involving inference and unification), let alone for a
large class of type theories.
