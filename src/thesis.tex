...
\begin{itemize}
  ...
  \item We present how self-description of signatures can be exploited to minimize metatheoretic
        assumptions.
  \item We describe ways to construct initial algebras from simple type formers.
\end{itemize}
...
inductive-inductive signatures.
...
do the same for path induction $\J$ in the ToS. We even have a Haskell
implementation of signature elaboration and computation of induction principles
for that ToS \cite{hiit-sig-program}.
