...
%% A type $\bA : \bTy\,\bGamma$ is a displayed flcwf over $\bGamma$.  As we have
%% seen before, displayed algebras can be computed as logical predicate
%% interpretations of algebraic signatures. Every underlying set in $\bA$ is a
%% family of sets over the ``base'' sets in $\bGamma$.
%% %% \begin{alignat*}{3}


%% \end{alignat*}

%% and every type/term former
%% and equation is indexed over the counterparts in the base.
