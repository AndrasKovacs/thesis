...
than that, and substantially more in Chapters \ref{chap:fqiit} and
\ref{chap:iqiit}.
...
theories. As we are aiming at minimalism right now, the current theory of
...
\end{alignat*}
Let us look at the presheaf interpretation now. We simplify functions with inner
...
ones which are external to a signature and do not depend on internally specified
constructors.
...
Let us refresh some details about the involved operations.
\begin{itemize}
