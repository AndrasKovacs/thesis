...
We can summarize the dependencies of chapters as follows:
\begin{itemize}
  \item Chapter \ref{chap:2ltt} depends on Chapter \ref{chap:simple-inductive-signatures}.
  \item All chapters after Chapter \ref{chap:2ltt} depend on it, since it describes a basic
        metatheoretic setup.
  \item Chapter \ref{chap:iqiit} revisits many constructions in Chapter \ref{chap:fqiit}.
...
Throughout this thesis, we always work in some sort of type theory, albeit the
exact flavor of the type theory will vary. We summarize here the notations and
conventions that will stay constant. Our style of notation is a mostly a mix of
