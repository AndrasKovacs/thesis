...
use 2LTT as metatheory. Thus, we mostly adapt the metatheoretical notations used
up until now. We list used features and conventions below.
...
\end{alignat*}
We can say that this \emph{defines} what it means for $\mbbC$ to support $\Pi$. We can
recover the usual non-higher-order specification of $\Pi$ in the following way, up to
isomorphism:
\begin{itemize}
...
cases where we have functions of the form $\Pi\,(\Tm_0\,A)\,B$. This will allow
...
\ref{sec:2ltt-simple-signatures}. First we look at the simply-typed case with
presheaf exponentials. We need some observations about the Yoneda embedding.
\begin{mylemma}
